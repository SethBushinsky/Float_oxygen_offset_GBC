function [n2s,o2s,ars,nes,KHn2,KHar,KHne,KHo2,ph2os,densw]=gassat07(temp,sal)
...
%       in DOE,1974
% Modified slightly to also output pH2O sat (SMB 2013_03_10)
% Modified to allow vector inputs. SMB - 2017_07_10
tabs = temp + 273.15;
P = 1.0;
Xn2 = .78084;
Xo2 = .20946;
